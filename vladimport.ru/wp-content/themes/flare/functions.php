...
function flare_scripts() {
		wp_enqueue_style( 'flare-style', get_stylesheet_uri(),'','2.5.5' );
		/*google fonts*/
        ...
        // REGISTER STYLE
	    wp_enqueue_style( 'bootstrap', $assets_url.'css/vendor/bootstrap.min.css', '', '2.5.1');
        ...
        wp_enqueue_script( 'app', $assets_url.'js/app.js', array(), 'v1.5.1');

        wp_enqueue_script( 'jquery-wow', $assets_url.'js/vender/wow.min.js', array('jquery'), '1.1.4', true );
        
        //ENQUEUE
        wp_enqueue_script( 'flare-main', $assets_url.'js/main.js', array('jquery'),null,true, '1.6' );
		...
		<div class="main-slider">
			...
			style="background-image: url('https://primasnabauto.ru/wp-content/uploads/2023/09/123.jpg');">
				<div class="carousel-caption wow fadeInUp">
					...
					<p>Друзья, приветствуем вас на нашем канале! Наша компания занимается таможенным оформлением автомобилей и привозом авто под заказ с аукционов Японии и Кореи. Здесь мы будем снимать обзоры на привезённые автомобили, рассказывать про новости в мире авто и показывать весь интересный процесс нашей работы! Подписывайтесь на нас в inst - @primasnabauto Мы находимся во Владивостоке ул. Нижнепортовая,1 тел.: 8-924-268-88-77 - ресепшн, 8-914-686-78-78 - по вопросам подбора и заказа авто.... </p>
